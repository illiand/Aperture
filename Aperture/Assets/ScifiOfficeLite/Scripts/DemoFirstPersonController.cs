        ...
        public void Look() {
            ...
            switch(controlType) {
                case ControlType.android:
                    int currentTouch;
                    //Find the touch that is trying to swipe the screen
                    ...
                    //If the finger in on the right side of the screen, get the distance changed since last frame
        ...
        void Walk() {
            ...
            switch(controlType) {
                case ControlType.android:
                    ...
                    displacement = playerBody.transform.forward * verticalInt + playerBody.transform.right * horizontalInt;
                    break;
